---
title: The Freedom That Is Not a Balance
subtitle: The agent-layer mirror of quantity substitution — freedom conflated with wealth, the exit that discloses which one you held, and why the only correction is diagnostic
type: method
layer: 3
status: CANDIDATE
...
edges:
  - derives_from → The Good That Is Not a Quantity (same engine: quantity substitution, agent locus)   # companion — provisional
  - derives_from → The Coordination Commons (money as tool of exchange, not driver; value is coordination utility, not price)
  - constrained_by → The Rights of Participants (self-determination = the right to exit = the right to sell)   # non-canonical label — normalize
  - contrasts_with → the enclosure sequence (purchased latitude is the toll-gate owner's "freedom")
related_rights: [self-determination, governance participation, unit of account integrity]
---
